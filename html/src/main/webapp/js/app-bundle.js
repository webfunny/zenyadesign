...
/***/ function(module, exports, __webpack_require__) {
	...
	window.loadModule = function (element,target,props){
		var object = React.createElement(__webpack_require__(158)("./"+element),props);
	...
	loadModule("common/ImgShow","frameCenter",{"imageSrc":"images/slides/slide3.jpg"});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./common/Center": 159,
		"./common/Center.js": 159,
		"./common/Footer": 160,
		"./common/Footer.js": 160,
		"./common/Frame": 161,
		"./common/Frame.js": 161,
		"./common/Header": 162,
		"./common/Header.js": 162,
		"./common/ImgShow": 163,
		"./common/ImgShow.js": 163,
		"./home/Company": 164,
		"./home/Company.js": 164,
		"./home/Contact": 165,
		"./home/Contact.js": 165,
		...
		"./main.js": 1,
		"./webpack.config": 168,
		"./webpack.config.js": 168,
		"./work/WorkDetail": 169,
		"./work/WorkDetail.js": 169
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Center = React.createClass({displayName: "Center",  
		render: function () {  
			return (
					React.createElement("table", {width: "100%", border: "0", align: "center"}, 
					  React.createElement("tr", null, 
					    React.createElement("td", null, 
					    React.createElement("div", {id: "wrapper"}, 
							React.createElement("div", {className: "fullwidthbanner-container"}, 
								React.createElement("div", {className: "fullwidthbanner"}, 
									React.createElement("ul", null, 
										React.createElement("li", {"data-transition": "3dcurtain-horizontal", "data-slotamount": "15", "data-masterspeed": "300"}, 
											React.createElement("img", {src: "images/slides/slide3.jpg", width: "100%", height: "100%", alt: ""})
										), 
										React.createElement("li", {"data-transition": "3dcurtain-vertical", "data-slotamount": "15", "data-masterspeed": "300", "data-link": "#"}, 
											React.createElement("img", {src: "images/slides/slide5.jpg", width: "100%", height: "100%", alt: ""})
										), 
										React.createElement("li", {"data-transition": "papercut", "data-slotamount": "15", "data-masterspeed": "300", "data-link": "#"}, 
											React.createElement("img", {src: "images/slides/slide2.jpg", width: "100%", height: "100%", alt: ""})
										), 
										React.createElement("li", {"data-transition": "turnoff", "data-slotamount": "15", "data-masterspeed": "300"}, 
											React.createElement("img", {src: "images/slides/slide1.jpg", width: "100%", height: "100%", alt: ""})
										), 
										React.createElement("li", {"data-transition": "flyin", "data-slotamount": "15", "data-masterspeed": "300"}, 
											React.createElement("img", {src: "images/slides/slide6.jpg", width: "100%", height: "100%", alt: ""})
										)
									)
								)
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = React.createClass({displayName: "Footer",  
		render: function () {  
			return (
					React.createElement("table", {width: "100%", height: "12", border: "0", style: {"text-align":"center","margin":"20px"}}, 
					  React.createElement("tr", null, 
					    React.createElement("td", null, React.createElement("div", {align: "center"}, "Contact Us: 131 2068 1656 ")), 
					    React.createElement("td", null, React.createElement("div", {align: "center"}, React.createElement("code", null, " Copyright @ ZENYA DESIGN 2014. All Rights Reserved."))), 
					    React.createElement("td", null, React.createElement("div", {align: "center"}, React.createElement("code", null, "沪ICP备14043482号-1")))
					  )
					)
			)
		}  
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Center = __webpack_require__(159); 
	var Footer = __webpack_require__(160); 

	var Frame = React.createClass({displayName: "Frame",  
		render: function () {  
			return (
					React.createElement("div", {id: "frameBody", style: {"width":"100%","height":"100%","margin":"0px"}}, 
						React.createElement("div", {id: "frameHeader", style: {"width":"80%","margin":"auto"}}, 
							React.createElement(Header, null)
						), 
						React.createElement("div", {id: "frameCenter", style: {"width":"100%","height":"auto","margin":"auto"}}, 
							React.createElement(Center, null)
						), 
						React.createElement("div", {id: "frameFooter", style: {"width":"80%","margin":"auto"}}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = React.createClass({displayName: "Menu",  
		...
		render: function () {
			...
			if(data.index == "0"){
				return (
						React.createElement("td", {width: "60", onClick: this.handleItem}, React.createElement("a", {href: ""}, this.props.data.menuName))
				)
			}else{
				return (
						React.createElement("td", {width: "60", onClick: this.handleItem}, React.createElement("a", {href: "#"}, this.props.data.menuName))
	...
	var Header = React.createClass({displayName: "Header", 
		...
		render: function () {  
			return (
					React.createElement("table", {width: "100%", height: "50", border: "0"}, 
						React.createElement("tr", null, 
							React.createElement("td", {width: "50%", height: "60"}, 
								React.createElement("img", {src: "images/zenya-logo.png", width: "300", height: "51"})
							), 
							React.createElement("td", {width: "50%", height: "60"}, 
								React.createElement("table", {width: "100%", height: "100%", border: "0"}, 
									React.createElement("tr", null, 
										React.createElement("td", {height: "23"}, " ")
									), 
									React.createElement("tr", null, 
										React.createElement(Menu, {data: MENUDATA[0]}), 
										React.createElement("td", {width: "20"}, "|"), 
										React.createElement(Menu, {data: MENUDATA[1]}), 
										React.createElement("td", {width: "20"}, "|"), 
										React.createElement(Menu, {data: MENUDATA[2]}), 
										React.createElement("td", {width: "20"}, "|"), 
										React.createElement(Menu, {data: MENUDATA[3]}), 
										React.createElement("td", {width: "20"}, "|"), 
										React.createElement(Menu, {data: MENUDATA[4]})
									)
								)
							)
						)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);  
	var Carousel = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-bootstrap\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).Carousel;
	var CarouselItem = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-bootstrap\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).CarouselItem;

	var ImgShow = React.createClass({displayName: "ImgShow",
		  getInitialState:function() {
		    return {
		      index: 0,
		      direction: null
		    ...
		    return (
		      React.createElement(Carousel, {activeIndex: this.state.index, direction: this.state.direction, onSelect: this.handleSelect}, 
		        React.createElement(CarouselItem, null, 
		          React.createElement("img", {width: 900, height: 500, alt: "900x500", src: "/assets/carousel.png"}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Company = React.createClass({displayName: "Company",  
		render: function () {  
			return (
					React.createElement("table", {width: "100%", border: "0", align: "center", style: {"text-align":"center","margin":"auto"}}, 
					  React.createElement("tr", null, 
					    React.createElement("td", {style: {"width":"100%"}}, 
							React.createElement("img", {src: "images/slides/slide3.jpg", width: "100%", alt: ""})
						)
					  )
					)
			)
		...
		render: function () {  
			return (
					React.createElement("table", {width: "100%", border: "0", align: "center", style: {"text-align":"center","margin":"auto"}}, 
					  React.createElement("tr", null, 
					    React.createElement("td", null, 
							React.createElement("img", {src: "images/slides/slide1.jpg", width: "100%", alt: ""})
						)
					  )
					)
			)
		...
		render: function () {  
			return (
					React.createElement("table", {width: "100%", border: "0", align: "center", style: {"text-align":"center","margin":"auto"}}, 
					  React.createElement("tr", null, 
					    React.createElement("td", null, 
							React.createElement("img", {src: "images/slides/slide2.jpg", width: "100%", alt: ""})
						)
					  )
					)
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorkCols = React.createClass({displayName: "WorkCols",  
		getInitialState: function() {
			return {
				data: {}
			};
		...
		render: function () {
			if(this.props.data.name == null){
				return (
						React.createElement("td", null, 
					    	React.createElement("div", {style: {"text-align":"center","margin":"0px","display":"block"}}, 
		            				React.createElement("p", {style: {"text-align":"center","width":"200px","height":"50px","word-break":"break-all"}}, this.props.data.name)
			                 )
						)
				)
			}else{
				return (
						React.createElement("td", null, 
					    	React.createElement("div", {style: {"text-align":"center","margin":"0px"}}, 
	            				React.createElement("a", {href: "#", onClick: this.handleItem}, 
	            					React.createElement("img", {src: this.props.data.img, width: "220", height: "145"})
	            				), 
	            				React.createElement("p", {style: {"text-align":"center","width":"200px","height":"50px","word-break":"break-all"}}, this.props.data.name)
			                 )
						)
	...
	var WorkRow = React.createClass({displayName: "WorkRow",  
		getInitialState: function() {
			return {
				datas: []
			};
		...
		render: function () {
			...
			this.props.datas.forEach(function(data) {
				cols.push(React.createElement(WorkCols, {data: data, key: data.id}));
			}.bind(this));
			return (
					React.createElement("tr", null, 
				    	cols
	...
	var TypeRow = React.createClass({displayName: "TypeRow",  
		getInitialState: function() {
			return {
				datas: [],
		...
		render: function () {
			return (
					React.createElement("tr", null, React.createElement("td", null, React.createElement("a", {href: "#", onClick: this.handlerQueryItem}, this.props.data.name)))
			)
		}  
	});		
	...
	var Work = React.createClass({displayName: "Work", 
		...
		render: function () { 
			...
			this.state.datas.forEach(function(data) {
				cols.push(data);
				if(index%3==0){
					rows.push(React.createElement(WorkRow, {datas: cols, key: data.id}));
					cols = [];
				}
				index++;
			}.bind(this));
			rows.push(React.createElement(WorkRow, {datas: cols, key: index}));
			...
			this.state.types.forEach(function(data) {
				typeRows.push(React.createElement(TypeRow, {data: data, key: data.id}));
			}.bind(this));
			return (
					React.createElement("div", {style: {"float":"left","width":"100%"}}, 
						React.createElement("table", {width: "300", height: "50px", border: "0", align: "center", style: {"margin-left":"0px","margin-top":"14px"}}, 
							typeRows
						), 
						React.createElement("table", {width: "80%", border: "0", align: "center", style: {"text-align":"center","margin-left":"200px","margin-top":"-151px"}}, 
							rows
						)
					)
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorkCols = React.createClass({displayName: "WorkCols",  
		...
		render: function () {
			return (
					React.createElement("td", {style: {"width":"100%","height":"100%"}}, 
				    	React.createElement("div", {style: {"text-align":"center","margin":"10px"}}, 
		            		React.createElement("div", null, 
		            			React.createElement("div", null, 
		            				React.createElement("a", {href: "#"}, 
		            					React.createElement("img", {src: this.props.data.img, width: "100%", height: "100%"})
		            				)
		            			), 
		            			React.createElement("div", null, 
		                            React.createElement("p", null, this.props.data.name, " - ", this.props.data.storeName)
		                        )
		            		)
		                 )
					)
	...
	var WorkDetail = React.createClass({displayName: "WorkDetail", 
		getInitialState: function() {
			return {
				datas: [],
		...
		render: function () { 
			...
			rows.push(React.createElement(WorkRow, {datas: cols, key: index}));
			return (
					React.createElement("table", {width: "80%", border: "0", align: "center", style: {"text-align":"center","margin":"auto"}}, 
					    rows
					)
			)
		}  
