...
(function(e, t) {
	...
	function a(t, n) {
		if (n.navigationType == "bullet" || n.navigationType == "both") {
			t.parent().append(
					'<div class="tp-bullets simplebullets ' + n.navigationStyle
							+ '"></div>')
		}
		var r = t.parent().find(".tp-bullets");
		t.find(">ul:first >li").each(
				function(e) {
	...
	function f(e, n) {
		...
		if (n.navigationArrow == "none")
			s = "visibility:none";
		e.parent().append(
				'<div style="' + s + '" class="tp-leftarrow tparrows '
						+ n.navigationStyle + '"></div>');
		e.parent().append(
				'<div style="' + s + '" class="tp-rightarrow tparrows '
						+ n.navigationStyle + '"></div>');
		...
		if (n.navigationType == "bullet") {
			...
			if (n.navigationArrows == "nexttobullets") {
				...
				if (n.navigationArrows == "verticalcentered") {
					...
					s.css({
						position : "absolute",
						left : Math.round(n.width - s.outerWidth() + l / 2)
								+ "px",
						top : Math.round(h / 2) + "px"
					});
					try {
				...
				.each(
						function(n) {
							...
							if (r.data("link") != t) {
								...
								if (i == "slide") {
									r
											.append('<div class="tp-caption sft slidelink" data-x="0" data-y="0" data-linktoslide="'
													+ o
	...
	function v(e, n, r) {
		...
		for (var h = 0; h < n.slots; h++)
			i
					.append('<div class="slot" style="position:absolute;top:'
							+ (0 + l)
							+ "px;left:"
							+ (f + h * n.slotw)
							...
							+ (0 - h * n.slotw) + "px;width:" + u
							+ "px;height:" + a + 'px" src="' + o
							+ '"></div></div>')
	}
	function m(e, n, r) {
		var i = e;
		...
		for (var h = 0; h < n.slots + 2; h++)
			i.append('<div class="slot" style="position:absolute;' + "top:"
					+ (l + h * n.sloth) + "px;" + "left:" + f + "px;"
					+ "overflow:hidden;" + "width:" + u + "px;" + "height:"
					+ n.sloth + 'px"'
					+ '><div class="slotslide" style="position:absolute;'
					+ "top:" + c + "px;" + "left:0px;width:" + u + "px;"
					+ "height:" + n.sloth + "px;"
					+ 'overflow:hidden;"><img style="position:absolute;'
					+ "top:" + (0 - h * n.sloth) + "px;" + "left:0px;width:"
					+ u + "px;" + "height:" + a + 'px" src="' + o
					+ '"></div></div>')
	}
	function g(e, n, r) {
		var i = e;
	...
	function w(n, r) {
		...
		if (r.ie
				&& (l == 17 || l == 16 || l == 2 || l == 3 || l == 9 || l == 10))
			l = Math.round(Math.random() * 3 + 12);
		if (r.ie9 && l == 3)
			l = 4;
		var h = 300;
		if (u.data("masterspeed") != t && u.data("masterspeed") > 99
		...
		if (l == 16) {
			...
			i.find(".tp-half-one").clone(true).appendTo(i).addClass(
					"tp-half-two");
						...
						function(i) {
							...
							if (a == 0) {
								...
								if (u.hasClass("randomrotate")
										&& (r.ie || r.ie9))
									u.removeClass("randomrotate").addClass(
											"sfb");
								...
								if (u.find("img").length > 0) {
									...
									if (u.find("iframe").length > 0) {
										...
										if (!u.hasClass("fullscreenvideo"))
											u.css({
												"font-size" : m.data("fsize")
														* r.bw + "px",
												"padding-top" : m.data("pt")
														* r.bh + "px",
												"padding-bottom" : m.data("pb")
														* r.bh + "px",
												"padding-left" : m.data("pl")
														* r.bw + "px",
												"padding-right" : m.data("pr")
														* r.bw + "px",
												"margin-top" : m.data("mt")
														* r.bh + "px",
												"margin-bottom" : m.data("mb")
														* r.bh + "px",
												"margin-left" : m.data("ml")
														* r.bw + "px",
												"margin-right" : m.data("mr")
														* r.bw + "px",
												"border-top" : m.data("bt")
														* r.bh + "px",
												"border-bottom" : m.data("bb")
														* r.bh + "px",
												"border-left" : m.data("bl")
														* r.bw + "px",
												"border-right" : m.data("br")
														* r.bw + "px",
												"line-height" : m.data("lh")
														* r.bh + "px",
												height : v * r.bh + "px",
												"white-space" : "nowrap"
											});
										...
										u.css({
											...
											"padding-right" : m.data("pr")
													* r.bw + "px",
											"margin-top" : m.data("mt") * r.bh
													+ "px",
											"margin-bottom" : m.data("mb")
													* r.bh + "px",
											"margin-left" : m.data("ml") * r.bw
													+ "px",
											"margin-right" : m.data("mr")
													* r.bw + "px",
											"border-top" : m.data("bt") * r.bh
													+ "px",
											"border-bottom" : m.data("bb")
													* r.bh + "px",
											"border-left" : m.data("bl") * r.bw
													+ "px",
											"border-right" : m.data("br")
													* r.bw + "px",
											"line-height" : m.data("lh") * r.bh
													+ "px",
											"white-space" : "nowrap"
										});
								...
								u.data("timer", setTimeout(function() {
									...
									if (u.hasClass("lfr") || u.hasClass("lfl")
											|| u.hasClass("sfr")
											|| u.hasClass("sfl")
											|| u.hasClass("lft")
											|| u.hasClass("lfb")
											...
											.data(
													...
													setTimeout(
															function() {
																if ((r.ie || r.ie9)
																		&& (u
																				.hasClass("randomrotate") || u
																				.hasClass("randomrotateout"))) {
																	u
																			.removeClass(
																					"randomrotate")
																			.removeClass(
	...
	function A(e, n) {
		...
		var s = e.data("repy");
		var o = e.data("repo");
		if (e.hasClass("ltr") || e.hasClass("ltl") || e.hasClass("str")
				|| e.hasClass("stl") || e.hasClass("ltt") || e.hasClass("ltb")
				|| e.hasClass("stt") || e.hasClass("stb")) {
			i = e.position().left;
			s = e.position().top;
			if (e.hasClass("ltr"))
				i = n.width + 20;
			...
			if (n.ie)
				e.addClass("noFilterClass")
		} else if (e.hasClass("lfr") || e.hasClass("lfl") || e.hasClass("sfr")
				|| e.hasClass("sfl") || e.hasClass("lft") || e.hasClass("lfb")
				|| e.hasClass("sft") || e.hasClass("sfb")) {
			if (e.hasClass("lfr"))
				i = n.width + 20;
	...
	function O(e, n) {
		...
		if (n.slideamount > 1 && !(n.stopAfterLoops == 0 && n.stopAtSlide == 1)) {
			...
			n.cdint = setInterval(function() {
				...
				if (n.conthover != 1 && n.videoplaying != true
				...
				revolution : function(r) {
					...
					return this
							.each(function() {
								var i = r;
								var o = e(this);
								i.firefox13 = e.browser.mozilla
										&& (parseInt(e.browser.version, 0) == 13
												|| parseInt(e.browser.version,
														0) == 14
												|| parseInt(e.browser.version,
														0) == 15 || parseInt(
												e.browser.version, 0) == 16);
								i.ie = e.browser.msie
										&& parseInt(e.browser.version, 0) < 9;
								i.ie9 = e.browser.msie
										&& parseInt(e.browser.version, 0) == 9;
								var u = e.fn.jquery.split("."), h = parseFloat(u[0]), p = parseFloat(u[1]), v = parseFloat(u[2]
										|| "0");
								if (h == 1 && p < 7) {
									o
								...
								if (i.shuffle == "on") {
									for (var m = 0; m < o
											.find(">ul:first-child >li").length; m++) {
										var g = Math
												.round(Math.random()
														* o
																.find(">ul:first-child >li").length);
										o.find(
												">ul:first-child >li:eq(" + g
														+ ")").prependTo(
								...
								if (i.width != i.startwidth) {
									i.height = Math.round(i.startheight
